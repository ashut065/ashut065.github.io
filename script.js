...
GitHubCalendar(".calendar", "ashut065", { responsive: true });
...
resumeLink.addEventListener("click", function (event) {
  ...
  window.open(
    "https://drive.google.com/file/d/1RID_CQylIW5CQwQKzQXlvAAFylSkzAEg/view?usp=sharing",
    "_blank"
  );
  let link = document.createElement("a");
  link.href =
    "https://drive.google.com/uc?export=download&id=1RID_CQylIW5CQwQKzQXlvAAFylSkzAEg";
  link.download = "ASHUTOSH-KUMAR-RESUME";
  link.click();
});
